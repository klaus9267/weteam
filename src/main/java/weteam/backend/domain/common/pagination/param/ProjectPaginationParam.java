...
public class ProjectPaginationParam extends AbstractPaginationParam {
  ...
  public ProjectPaginationParam(final Integer page, final Integer size, final Boolean done, final Long userId, final PaginationSortType field, final Sort.Direction direction) {
